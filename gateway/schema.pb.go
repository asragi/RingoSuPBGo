...
var file_gateway_schema_proto_rawDesc = []byte{
	...
	0x75, 0x69, 0x72, 0x65, 0x64, 0x4c, 0x76, 0x42, 0x0a, 0x5a, 0x08, 0x2f, 0x67, 0x61, 0x74, 0x65,
...
var file_gateway_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_gateway_schema_proto_goTypes = []interface{}{
	(*GetStageActionDetailResponse)(nil), // 0: ringosu.GetStageActionDetailResponse
	(*RequiredItem)(nil),                 // 1: ringosu.RequiredItem
	(*EarningItem)(nil),                  // 2: ringosu.EarningItem
	(*RequiredSkill)(nil),                // 3: ringosu.RequiredSkill
}
var file_gateway_schema_proto_depIdxs = []int32{
	1, // 0: ringosu.GetStageActionDetailResponse.required_items:type_name -> ringosu.RequiredItem
	2, // 1: ringosu.GetStageActionDetailResponse.earning_items:type_name -> ringosu.EarningItem
	3, // 2: ringosu.GetStageActionDetailResponse.required_skills:type_name -> ringosu.RequiredSkill
